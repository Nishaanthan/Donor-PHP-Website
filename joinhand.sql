...
CREATE TABLE `donor` (
  `id` int(11) NOT NULL,
  `image` varbinary(30) DEFAULT NULL,
...
(2, NULL, 'Donor', NULL, 'Afghanistan', 'donor@example.com', NULL, '$2y$10$gFN7wZrT3NMj/FQbv5tbVeckd4T2EtC9D7m6R9begHH2yVY4wWMmq', 'fbd7939d674997cdb4692d34de8633c4', 0);
...
(4, 'NGO', 'Afghanistan', 'NGO@example.com', '$2y$10$ambT2JRaGNK.PdDtPrUKQOvuSVj1T.F3iq0P24srUDgchLg8ieMr2', '371bce7dc83817b7893bcdeed13799b5', 0);
...
(2, 'Requester', 'Afghanistan', 'requester@example.com', '$2y$10$cCKFhq0mo/sldiGoTCv44.kor8gzvWxyji90X7EkgPqZrhVKAofIW', 'e46de7e1bcaaced9a54f1e9d0d2f800d', 0);
